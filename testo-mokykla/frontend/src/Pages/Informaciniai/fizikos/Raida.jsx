...
function Raida()
{
    return (
        <UI>
        {
             ...
             <p1>
             Viena iš pagrindinių teorijų yra Didysis Sprogimas (Big Bang), pagal kurią visata susiformavo iš pradžios taško ir nuolat išsiplėto nuo to momento. Didysis Sprogimas įvyko apie 13,8 milijardo metų ir yra palaikomas daugybe astronominių stebėjimų ir matavimų. 
             </p1>
             <h2>Planetos</h2>
             <p2>
             <li>Jupiteris:
