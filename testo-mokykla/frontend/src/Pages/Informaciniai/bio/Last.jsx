...
function Last()
{
    return (
        <UI>
        {
             ...
             <p1>
                <li>Ląstelė – visų gyvybės formų mažiausias vienetas.
...
a)mitochondrijos ir chloroplastai panašaus dydžio ir sandaros į bakterijas;

b)turi dvigubą membraną, susidariusią iš jų membranos ir pūslelės membranos;

c)turi DNR ir dalijasi pusiau;

d)gali pasigaminti baltymų, ribosomos panašios į bakterijų ribosomas;

e)RNR bazių seka atitinka bakterijų RNR bazių seką.
