...
Dauguma metalų reaguoja su rūgštimis, išskiriant vandenilį ir sudarant metalo druskas.
Šilumos laidumo savybės:

Metalai gerai laiduoja šilumą, todėl dažnai naudojami kaip šilumos laidžiai elementai.
Tirpumas:

Kai kurie metalai gali būti tirpstantys skystose medžiagose, kaip pavyzdžiui, živinas.
Metalų grupės:

Periodinėje cheminių elementų lentelėje metalai gali būti suskirstyti į alkalių metalus, žemės alkalinius metalus, perėjimo metalus, švino grupės metalus ir kt.
Korozija:

Metalai gali reaguoti su aplinkos elementais ir sudaryti korozijos produktus, kurie gali paveikti metalo struktūrą.
