...
const router = createBrowserRouter([
  ...
  <Route element={<PrivateRoutes />}>
    ...
    <Route path="fizika" element={<Fizika />}>
      ...
      <Route path="radioaktyvumas/poveikis-aplinkai" element={<Aplinka />} />
      <Route path="radioaktyvumas/poveikis-žmogui" element={<Žmogus />} />
      <Route path="radioaktyvumas/spinduliuotės" element={<Spinduliuotės />} />
      <Route path="elektros-srovė/terpėse" element={<Terpėse />} />
      <Route path="elektros-srovė/nuolatinė" element={<Nuolatinė />} />
      <Route path="elektros-srovė/taikymas-pramonėje" element={<Taikymas />} />
    ...
    <Route path="chemija" element={<Chemija />}>
      ...
      <Route path="organinė/karboksirūgštys" element={<Karboksirūgštys />} />
    </Route>
    ...
    <Route path="lietuviu" element={<Lietuviu />}>
      ...
      <Route path="skyryba/vienarūšės-sakinio-dalys" element={<Vienarūšės />} />
